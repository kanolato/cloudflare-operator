...
// +kubebuilder:rbac:groups=cloudflare.kanolato.dev,resources=dnsrecords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudflare.kanolato.dev,resources=dnsrecords/status,verbs=get;update;patch
